...
function ReceiptModal({ modalVal, setModalVal }: any) {
        ...
        <div>
            {modalVal ? <div role="dialog" aria-modal="true">
                ...
                <div onClick={() => setModalVal(false)} className=" fixed inset-0 z-10 flex items-center justify-center w-screen overflow-y-auto">
                    <div onClick={(e) => e.stopPropagation()} className=' w-[624px]  rounded-sm h-[712px] bg-white'>
                        ...
                        <div className=' flex gap-4 mt-6 flex-col items-center justify-center'>
                            ...
                            <button className='h-[48px] w-[80%] rounded-xl border-2 border-red-600 text-red-600 flex items-center text-[20px] font-semibold justify-center'>
                                عدم تایید
                            </button>
                        </div>
                    </div>
